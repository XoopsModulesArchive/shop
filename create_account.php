...
/*
  $Id: create_account.php,v 1.1 2006/03/27 08:42:21 mikhail Exp $
...
if (isset($_POST['action']) && ('process' == $_POST['action'])) {
    ...
    if (ACCOUNT_DOB == 'true') {
        if (false === checkdate(mb_substr(tep_date_raw($dob), 4, 2), mb_substr(tep_date_raw($dob), 6, 2), mb_substr(tep_date_raw($dob), 0, 4))) {
            $error = true;
    ...
    } elseif (false === tep_validate_email($email_address)) {
        $error = true;
    ...
    if (mb_strlen($password) < ENTRY_PASSWORD_MIN_LENGTH) {
        $error = true;
                                    ...
                                    <table border="0" cellspacing="2" cellpadding="2">
                                        ...
                                        if (ACCOUNT_GENDER == 'true') {
                                            ...
                                            <tr>
                                                ...
                                                <td class="main"><?php echo tep_draw_radio_field('gender', 'm') . '&nbsp;&nbsp;' . MALE . '&nbsp;&nbsp;' . tep_draw_radio_field('gender', 'f') . '&nbsp;&nbsp;' . FEMALE . '&nbsp;' . (tep_not_null(ENTRY_GENDER_TEXT) ? '<span class="inputRequirement">'
                                                                                                                                                                                                                                                                         . ENTRY_GENDER_TEXT
                                                                                                                                                                                                                                                                         . '</span>' : ''); ?></td>
                                            </tr>
                                            <?php

        ...
        <td width="100%" valign="top">
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                if (isset($_GET['action']) && ($_GET['action'] == 'success')) {
                    ...
                    ?>
                    <tr>
                        <td><?php echo tep_draw_form('contact_us', tep_href_link(FILENAME_AFFILIATE_CONTACT, 'action=send')); ?>
                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                <tr>
                                ...
                                <tr>
                                    <td class="main"><?php echo ENTRY_EMAIL; ?><br><?php echo tep_draw_input_field('email', $affiliate['affiliate_email_address'], 'size=40');
                                        if ($error) {

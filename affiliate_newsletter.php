...
<table border="0" width="100%" cellspacing="3" cellpadding="3">
    <tr>
        ...
        <!-- body_text //-->
        <td width="100%" valign="top"><?php echo tep_draw_form('account_newsletter', tep_href_link(FILENAME_AFFILIATE_NEWSLETTER, '', 'SSL')) . tep_draw_hidden_field('action', 'process'); ?>

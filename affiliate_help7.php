...
/*
  $Id: affiliate_help7.php,v 2.00 2004/10/12
...
if (in_array('remove_current_page', get_class_methods($navigation), true)) {
...
<?php
$info_box_contents = [];
$info_box_contents[] = ['text' => HEADING_SUMMARY_HELP];

new infoBoxHeading($info_box_contents, true, true);

$info_box_contents = [];
$info_box_contents[] = ['text' => TEXT_COMMISSION_RATE_HELP];

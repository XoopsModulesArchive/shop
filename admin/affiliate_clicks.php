...
/*
  $Id: affiliate_clicks.php,v 2.00 2004/10/12
...
if ($_GET['acID'] > 0) {
    $affiliate_clickthroughs_raw = 'select ac.*, pd.products_name, a.affiliate_firstname, a.affiliate_lastname from '
                                   . TABLE_AFFILIATE_CLICKTHROUGHS
                                   . ' ac left join '
                                   . TABLE_PRODUCTS
                                   . ' p on (p.products_id = ac.affiliate_products_id) left join '
                                   . TABLE_PRODUCTS_DESCRIPTION
                                   . " pd on (pd.products_id = p.products_id and pd.language_id = '"
                                   . $languages_id
                                   . "') left join "
                                   . TABLE_AFFILIATE
                                   . " a  on (a.affiliate_id = ac.affiliate_id) where a.affiliate_id = '"
                                   . $_GET['acID']
                    ...
                    <td>
                        <table border="0" width="100%" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                if ($_GET['acID'] > 0) {
                                    ?>
                                    <td class="pageHeading" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_AFFILIATE_STATISTICS, tep_get_all_get_params(['action'])) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a>'; ?></td>
                                    <?php
                                } else {
                                    ?>
                                ...
                                <td valign="top">
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        ...
                                        if ($affiliate_clickthroughs_numrows > 0) {
                                            ...
                                            while (false !== ($affiliate_clickthroughs = tep_db_fetch_array($affiliate_clickthroughs_values))) {
                                            ...
                                            <td class="smallText" colspan="7">
                                                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                    <tr>
                                                        ...
                                                        <td class="smallText" align="right"><?php echo $affiliate_clickthroughs_split->display_links(
                                            $affiliate_clickthroughs_numrows,
                                            MAX_DISPLAY_SEARCH_RESULTS,
                                            MAX_DISPLAY_PAGE_LINKS,
                                            $_GET['page'],
                                            tep_get_all_get_params(['page', 'oID', 'action'])
                                        ); ?></td>
                                                    </tr>
                                                </table>
                                            </td>

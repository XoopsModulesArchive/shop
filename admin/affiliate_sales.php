...
/*
  $Id: affiliate_sales.php,v 2.00 2004/10/12
                    ...
                    <td valign="top">
                        <table border="0" width="100%" cellspacing="0" cellpadding="4">
                            ...
                            if ($affiliate_sales_numrows > 0) {
                                ...
                                while (false !== ($affiliate_sales = tep_db_fetch_array($affiliate_sales_values))) {
                                    $number_of_sales++;
                                    ...
                                    <td class="dataTableContent" align="center"><?php if ($affiliate_sales['orders_status']) {
                                    ...
                                    <td colspan="7">
                                        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                            <tr>
                                                ...
                                                <td class="smallText" align="right"><?php echo $affiliate_sales_split->display_links($affiliate_sales_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $_GET['page'], tep_get_all_get_params(['page', 'info', 'x', 'y'])); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>

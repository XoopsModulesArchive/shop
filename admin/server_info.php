...
/*
  $Id: server_info.php,v 1.1 2006/03/27 09:05:33 mikhail Exp $
                    ...
                    <td>
                        ...
                        if (function_exists('ob_start')) {
                            ...
                            echo '<table border="1" cellpadding="3" width="600" style="border: 0px; border-color: #000000;">'
                                 . '  <tr><td><a href="http://www.oscommerce.com"><img border="0" src="images/oscommerce.gif" alt=" osCommerce "></a><h1 class="p"> '
                                 . PROJECT_VERSION
                                 . '</h1></td>'
                                 . '  </tr>'
                                 . '</table>';

...
/*
  $Id: cache.php,v 1.1 2006/03/27 09:05:33 mikhail Exp $
                                    ...
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        ...
                                        if ($messageStack->size < 1) {
                                            ...
                                            for ($i = 0, $n = count($languages); $i < $n; $i++) {
                                                if (DEFAULT_LANGUAGE == $languages[$i]['code']) {
                                            ...
                                            for ($i = 0, $n = count($cache_blocks); $i < $n; $i++) {
                                                ...
                                                <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                                                    ...
                                                    <td class="dataTableContent" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_CACHE, 'action=reset&block=' . $cache_blocks[$i]['code'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_reset.gif', 'Reset', 13, 13) . '</a>'; ?>
                                                        &nbsp;
                                                    </td>
                                                </tr>
                                                <?php

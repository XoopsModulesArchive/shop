...
/*
  $Id: customers.php,v 1.1 2006/03/27 09:05:33 mikhail Exp $
...
if (tep_not_null($action)) {
    switch ($action) {
        case 'update':
            ...
            if (mb_strlen($customers_firstname) < ENTRY_FIRST_NAME_MIN_LENGTH) {
                $error = true;
            ...
            if (mb_strlen($customers_lastname) < ENTRY_LAST_NAME_MIN_LENGTH) {
                $error = true;
            ...
            if (ACCOUNT_DOB == 'true') {
                if (checkdate(mb_substr(tep_date_raw($customers_dob), 4, 2), mb_substr(tep_date_raw($customers_dob), 6, 2), mb_substr(tep_date_raw($customers_dob), 0, 4))) {
            ...
            if (mb_strlen($customers_email_address) < ENTRY_EMAIL_ADDRESS_MIN_LENGTH) {
                $error = true;
            ...
            if (mb_strlen($entry_street_address) < ENTRY_STREET_ADDRESS_MIN_LENGTH) {
                $error = true;
            ...
            if (mb_strlen($entry_postcode) < ENTRY_POSTCODE_MIN_LENGTH) {
                $error = true;
            ...
            if (mb_strlen($entry_city) < ENTRY_CITY_MIN_LENGTH) {
                $error = true;
            ...
            if (mb_strlen($customers_telephone) < ENTRY_TELEPHONE_MIN_LENGTH) {
                $error = true;
...
'entry_country_id' => $entry_country_id,
                ...
                tep_redirect(tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(['cID', 'action']) . 'cID=' . $customers_id));
            } elseif (true === $error) {
        ...
        case 'deleteconfirm':
            ...
            if (isset($_POST['delete_reviews']) && ('on' == $_POST['delete_reviews'])) {
                ...
                while (false !== ($reviews = tep_db_fetch_array($reviews_query))) {
            ...
            tep_redirect(tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(['cID', 'action'])));
            break;
        default:
        ...
        <td width="100%" valign="top">
            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                ...
                if ('edit' == $action || 'update' == $action) {
                    ...
                    <tr><?php echo tep_draw_form('customers', FILENAME_CUSTOMERS, tep_get_all_get_params(['action']) . 'action=update', 'post', 'onSubmit="return check_form();"') . tep_draw_hidden_field('default_address_id', $cInfo->customers_default_address_id); ?>
                                        ...
                                        <td class="main">
                                            ...
                                            if (true === $error) {
                                                if (true === $entry_gender_error) {
                                                    echo tep_draw_radio_field('customers_gender', 'm', false, $cInfo->customers_gender)
                                                         . '&nbsp;&nbsp;'
                                                         . MALE
                                                         . '&nbsp;&nbsp;'
                                                         . tep_draw_radio_field('customers_gender', 'f', false, $cInfo->customers_gender)
                                                         . '&nbsp;&nbsp;'
                                                         . FEMALE
                                                         . '&nbsp;'
                                                         . ENTRY_GENDER_ERROR;
                                                } else {
                                                    echo ('m' == $cInfo->customers_gender) ? MALE : FEMALE;
                                    ...
                                    if (true === $error) {
                                        if (true === $entry_state_error) {
                                            if (true === $entry_state_has_zones) {
                                                ...
                                                while (false !== ($zones_values = tep_db_fetch_array($zones_query))) {
                            ...
                            <table border="0" cellspacing="2" cellpadding="2">
                                <tr>
                                    ...
                                    <td class="main">
                                        <?php
                                        if (true === $processed) {
                                            if ('1' == $cInfo->customers_newsletter) {
                                            ...
                                            echo tep_draw_pull_down_menu('customers_newsletter', $newsletter_array, (('1' == $cInfo->customers_newsletter) ? '1' : '0'));
                                        } ?></td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="right" class="main"><?php echo tep_image_submit('button_update.gif', IMAGE_UPDATE) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(['action'])) . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>'; ?></td>
                    </tr></form>
                    <?php
                } else {
                    ?>
                    ...
                    $customers_query_raw = 'select c.customers_id, c.customers_lastname, c.customers_firstname, c.customers_email_address, a.entry_country_id from '
                                                                   ...
                                                                   . ' c left join '
                                                                   . TABLE_ADDRESS_BOOK
                                                                   . ' a on c.customers_id = a.customers_id and c.customers_default_address_id = a.address_book_id '
                                                                   . $search
                    ...
                    while (false !== ($customers = tep_db_fetch_array($customers_query))) {
                        $info_query = tep_db_query(
                            'select customers_info_date_account_created as date_account_created, customers_info_date_account_last_modified as date_account_last_modified, customers_info_date_of_last_logon as date_last_logon, customers_info_number_of_logons as number_of_logons from '
                        ...
                        if (isset($cInfo) && is_object($cInfo) && ($customers['customers_id'] == $cInfo->customers_id)) {
                            echo '          <tr id="defaultSelected" class="dataTableRowSelected" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . tep_href_link(
                                FILENAME_CUSTOMERS,
                                tep_get_all_get_params(['cID', 'action']) . 'cID=' . $cInfo->customers_id . '&action=edit'
                            ) . '\'">' . "\n";
                        } else {
                            echo '          <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)" onclick="document.location.href=\'' . tep_href_link(
                                FILENAME_CUSTOMERS,
                                tep_get_all_get_params(['cID']) . 'cID=' . $customers['customers_id']
                            ) . '\'">' . "\n";
                        } ?>
                            ...
                            echo '<a href="' . tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(['cID']) . 'cID=' . $customers['customers_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>';
                        } ?>&nbsp;
                                                </td>
                                                </tr>
                                                <?php
                                                ...
                                                <td colspan="4">
                                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                        <tr>
                                                            ...
                                                            <td class="smallText" align="right"><?php echo $customers_split->display_links(
                            $customers_query_numrows,
                            MAX_DISPLAY_SEARCH_RESULTS,
                            MAX_DISPLAY_PAGE_LINKS,
                            $_GET['page'],
                            tep_get_all_get_params(['page', 'info', 'x', 'y', 'cID'])
                        ); ?></td>
                                                        </tr>
                                                        <?php
                                                        if (isset($_GET['search']) && tep_not_null($_GET['search'])) {
                    ...
                    switch ($action) {
                                        case 'confirm':
                                            ...
                                            $contents = ['form' => tep_draw_form('customers', FILENAME_CUSTOMERS, tep_get_all_get_params(['cID', 'action']) . 'cID=' . $cInfo->customers_id . '&action=deleteconfirm')];
                                            ...
                                            $contents[] = [
                                                'align' => 'center',
'text' => '<br>' . tep_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(['cID', 'action']) . 'cID=' . $cInfo->customers_id) . '">' . tep_image_button(
    'button_cancel.gif',
    IMAGE_CANCEL
) . '</a>',
                                            ];
                                        ...
                                        default:
                                            if (isset($cInfo) && is_object($cInfo)) {
                                                ...
                                                $contents[] = [
                                                    'align' => 'center',
'text' => '<a href="' . tep_href_link(FILENAME_CUSTOMERS, tep_get_all_get_params(['cID', 'action']) . 'cID=' . $cInfo->customers_id . '&action=edit') . '">' . tep_image_button('button_edit.gif', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(
    FILENAME_CUSTOMERS,
    tep_get_all_get_params(['cID', 'action']) . 'cID=' . $cInfo->customers_id . '&action=confirm'
) . '">' . tep_image_button('button_delete.gif', IMAGE_DELETE) . '</a> <a href="' . tep_href_link(FILENAME_ORDERS, 'cID=' . $cInfo->customers_id) . '">' . tep_image_button('button_orders.gif', IMAGE_ORDERS) . '</a> <a href="' . tep_href_link(
                                                            FILENAME_MAIL,
                                                            'selected_box=tools&customer=' . $cInfo->customers_email_address

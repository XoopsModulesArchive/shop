...
/*
  $Id: index.php,v 1.1 2006/03/27 09:05:33 mikhail Exp $
...
'children' => [
            ['title' => BOX_CONFIGURATION_MYSTORE, 'link' => tep_href_link(FILENAME_CONFIGURATION, 'selected_box=configuration&gID=1')],
            ['title' => BOX_CONFIGURATION_LOGGING, 'link' => tep_href_link(FILENAME_CONFIGURATION, 'selected_box=configuration&gID=10')],
            ['title' => BOX_CONFIGURATION_CACHE, 'link' => tep_href_link(FILENAME_CONFIGURATION, 'selected_box=configuration&gID=11')],
        ],
    ],
    [
...
'children' => [
            ['title' => BOX_MODULES_PAYMENT, 'link' => tep_href_link(FILENAME_MODULES, 'selected_box=modules&set=payment')],
            ['title' => BOX_MODULES_SHIPPING, 'link' => tep_href_link(FILENAME_MODULES, 'selected_box=modules&set=shipping')],
        ],
    ],
    [
        'title' => BOX_HEADING_CATALOG,
'image' => 'catalog.gif',
'href' => tep_href_link(FILENAME_CATEGORIES, 'selected_box=catalog'),
'children' => [
            ['title' => CATALOG_CONTENTS, 'link' => tep_href_link(FILENAME_CATEGORIES, 'selected_box=catalog')],
            ['title' => BOX_CATALOG_MANUFACTURERS, 'link' => tep_href_link(FILENAME_MANUFACTURERS, 'selected_box=catalog')],
        ],
    ],
    [
        'title' => BOX_HEADING_LOCATION_AND_TAXES,
'image' => 'location.gif',
'href' => tep_href_link(FILENAME_COUNTRIES, 'selected_box=taxes'),
'children' => [
            ['title' => BOX_TAXES_COUNTRIES, 'link' => tep_href_link(FILENAME_COUNTRIES, 'selected_box=taxes')],
            ['title' => BOX_TAXES_GEO_ZONES, 'link' => tep_href_link(FILENAME_GEO_ZONES, 'selected_box=taxes')],
        ],
    ],
    [
...
'children' => [
            ['title' => BOX_CUSTOMERS_CUSTOMERS, 'link' => tep_href_link(FILENAME_CUSTOMERS, 'selected_box=customers')],
            ['title' => BOX_CUSTOMERS_ORDERS, 'link' => tep_href_link(FILENAME_ORDERS, 'selected_box=customers')],
        ],
    ],
    [
        'title' => BOX_HEADING_LOCALIZATION,
'image' => 'localization.gif',
'href' => tep_href_link(FILENAME_CURRENCIES, 'selected_box=localization'),
'children' => [
            ['title' => BOX_LOCALIZATION_CURRENCIES, 'link' => tep_href_link(FILENAME_CURRENCIES, 'selected_box=localization')],
            ['title' => BOX_LOCALIZATION_LANGUAGES, 'link' => tep_href_link(FILENAME_LANGUAGES, 'selected_box=localization')],
        ],
    ],
    [
        'title' => BOX_HEADING_REPORTS,
'image' => 'reports.gif',
'href' => tep_href_link(FILENAME_STATS_PRODUCTS_PURCHASED, 'selected_box=reports'),
'children' => [
            ['title' => REPORTS_PRODUCTS, 'link' => tep_href_link(FILENAME_STATS_PRODUCTS_PURCHASED, 'selected_box=reports')],
            ['title' => REPORTS_ORDERS, 'link' => tep_href_link(FILENAME_STATS_CUSTOMERS, 'selected_box=reports')],
        ],
    ],
...
'children' => [
            ['title' => BOX_AFFILIATE, 'link' => tep_href_link(FILENAME_AFFILIATE, 'selected_box=affiliate')],
            ['title' => BOX_AFFILIATE_BANNERS, 'link' => tep_href_link(FILENAME_AFFILIATE_BANNERS, 'selected_box=affiliate')],
        ],
    ],
...
'children' => [
            ['title' => TOOLS_BACKUP, 'link' => tep_href_link(FILENAME_BACKUP, 'selected_box=tools')],
            ['title' => TOOLS_BANNERS, 'link' => tep_href_link(FILENAME_BANNER_MANAGER, 'selected_box=tools')],
            ['title' => TOOLS_FILES, 'link' => tep_href_link(FILENAME_FILE_MANAGER, 'selected_box=tools')],
        ],
    ],
];
                    ...
                    <td>
                        <table border="0" width="600" height="440" cellspacing="0" cellpadding="0">
                            <tr bgcolor="#ffffff" height="50">
                                ...
                                <td align="right" class="text" nowrap><?php echo '<a href="'
                                                                                 ...
                                                                                 . '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.oscommerce.com" target="_blank">'
                                                                                 . HEADER_TITLE_SUPPORT_SITE
                                                                                 . '</a>'; ?>&nbsp;&nbsp;
                                </td>
                            </tr>
                            <tr bgcolor="#080381">
                                <td colspan="2">
                                    <table border="0" width="460" height="390" cellspacing="0" cellpadding="2">
                                        <tr valign="top">
                                            <td width="160" valign="top">
                                                <table border="0" width="160" height="390" cellspacing="0" cellpadding="2">
                                                    <tr>
                                                        <td valign="top"><br>
                                                            <?php
                                                            $heading = [];
...
'text' => 'osCommerce',
                                                            ...
                                                            $contents[] = [
                                                                'params' => 'class="infoBox"',
'text' => '<a href="http://www.oscommerce.com" target="_blank">'
                                                                            . BOX_ENTRY_SUPPORT_SITE
                                                                            . '</a><br>'
                                                                            . '<a href="http://www.oscommerce.com/community.php/forum" target="_blank">'
                                                                            . BOX_ENTRY_SUPPORT_FORUMS
                                                                            . '</a><br>'
                                                                            . '<a href="http://www.oscommerce.com/community.php/mlists" target="_blank">'
                                                                            . BOX_ENTRY_MAILING_LISTS
                                                                            . '</a><br>'
                                                                            . '<a href="http://www.oscommerce.com/community.php/bugs" target="_blank">'
                                                                            . BOX_ENTRY_BUG_REPORTS
                                                                            . '</a><br>'
                                                                            . '<a href="http://www.oscommerce.com/community.php/faq" target="_blank">'
                                                                            . BOX_ENTRY_FAQ
                                                                            . '</a><br>'
                                                                            . '<a href="http://www.oscommerce.com/community.php/irc" target="_blank">'
                                                                            . BOX_ENTRY_LIVE_DISCUSSIONS
                                                                            . '</a><br>'
                                                                            . '<a href="http://www.oscommerce.com/community.php/cvs" target="_blank">'
                                                                            . BOX_ENTRY_CVS_REPOSITORY
                                                                            . '</a><br>'
                                                                            . '<a href="http://www.oscommerce.com/about.php/portal" target="_blank">'
                                                            ...
                                                            while (false !== ($orders_status = tep_db_fetch_array($orders_status_query))) {
                                                            ...
                                                            $orders_contents = mb_substr($orders_contents, 0, -4);
...
'text' => BOX_TITLE_STATISTICS,
                                                            ...
                                                            $contents[] = [
                                                                'params' => 'class="infoBox"',
'text' => BOX_ENTRY_CUSTOMERS . ' ' . $customers['count'] . '<br>' . BOX_ENTRY_PRODUCTS . ' ' . $products['count'] . '<br>' . BOX_ENTRY_REVIEWS . ' ' . $reviews['count'],
                                                            ];
...
'text' => BOX_TITLE_AFFILIATES,
                                                            ...
                                                            $contents[] = [
                                                                'params' => 'class="infoBox"',
'text' => BOX_ENTRY_AFFILIATES . ' ' . $affiliate_number . '<br>' . BOX_ENTRY_CONVERSION . ' ' . $affiliate_conversions . '<br>' . BOX_ENTRY_COMMISSION . ' ' . $currencies->display_price($affiliate_commission, ''),
                                                            ];
                                                ...
                                                <table border="0" width="460" height="390" cellspacing="0" cellpadding="2">
                                                    ...
                                                    for ($i = 0, $n = count($cat); $i < $n; $i++) {
                                                        ...
                                                        echo '                    <td><table border="0" cellspacing="0" cellpadding="2">'
                                                             ...
                                                             . '">'
                                                             . tep_image(
                                                                 DIR_WS_IMAGES . 'categories/' . $cat[$i]['image'],
                                                                 $cat[$i]['title'],
                                                                 '32',
                                                                 '32'
                                                             )

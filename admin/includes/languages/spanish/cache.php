...
/*
  $Id: cache.php,v 1.1 2006/03/27 08:51:50 mikhail Exp $
...
define('ERROR_CACHE_DIRECTORY_DOES_NOT_EXIST', 'Error: No existe el directorio para la caché. Please set this in configure.php.');

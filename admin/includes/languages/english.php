...
/*
  $Id: english.php,v 1.1 2006/03/27 08:43:59 mikhail Exp $
...
{
    if ($reverse) {
        return mb_substr($date, 3, 2) . mb_substr($date, 0, 2) . mb_substr($date, 6, 4);
    }

    return mb_substr($date, 6, 4) . mb_substr($date, 0, 2) . mb_substr($date, 3, 2);
}

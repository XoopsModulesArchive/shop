...
define('TABLE_AFFILIATE_NEWSLETTERS', XOOPS_SHOPDB_PREFIX . '_affiliate_newsletters');
...
if ('deleteconfirm' == $_GET['action'] && FILENAME_ORDERS == basename($HTTP_SERVER_VARS['SCRIPT_FILENAME']) && AFFILIATE_DELETE_ORDERS == 'true') {

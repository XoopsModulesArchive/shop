...
/*
  $Id: product_notification.php,v 1.1 2006/03/27 08:46:35 mikhail Exp $
...
//--></script>';
        ...
        $global_button = '<script language="javascript"><!--' . "\n" . 'document.write(\'<input type="button" value="' . BUTTON_GLOBAL . '" style="width: 8em;" onclick="document.location=\\\'' . tep_href_link(
        ...
        $cancel_button = '<script language="javascript"><!--'
                         ...
                         . BUTTON_CANCEL
                         . '" style="width: 8em;" onclick="document.location=\\\''
                         . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&nID=' . $_GET['nID'])
                         . '\\\'">\');'
                         . "\n"
        ...
        $choose_audience_string .= '<form name="notifications" action="'
                                   . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&nID=' . $_GET['nID'] . '&action=confirm')
                                   . '" method="post" onSubmit="return selectAll(\'notifications\', \'chosen[]\')"><table border="0" width="100%" cellspacing="0" cellpadding="2">'
                                   . "\n"
                                   . '  <tr>'
                                   . "\n"
                                   . '    <td align="center" class="main"><b>'
                                   . TEXT_PRODUCTS
                                   . '</b><br>'
                                   ...
                                   . BUTTON_SELECT
                                   . '" style="width: 8em;" onClick="mover(\'remove\');"><br><br><input type="button" value="'
                                   . BUTTON_UNSELECT
                                   . '" style="width: 8em;" onClick="mover(\'add\');"><br><br><br><input type="submit" value="'
                                   . BUTTON_SUBMIT
                                   . '" style="width: 8em;"><br><br>'
                                   . $cancel_button
                                   . '</td>'
                                   . "\n"
                                   . '    <td align="center" class="main"><b>'
                                   ...
                                   . '</b><br>'
                                   . tep_draw_pull_down_menu('chosen[]', [], '', 'size="20" style="width: 20em;" multiple')
                                   . '</td>'
                                   . "\n"
                                   . '  </tr>'
                                   . "\n"
    ...
    public function confirm()
    {
        ...
        if (isset($_GET['global']) && ('true' == $_GET['global'])) {
        ...
        $confirm_string = '<table border="0" cellspacing="0" cellpadding="2">'
                          ...
                          . '  <tr>'
                          . "\n"
                          . '    <td class="main"><font color="#ff0000"><b>'
                          . sprintf(TEXT_COUNT_CUSTOMERS, count($audience))
                          . '</b></font></td>'
                          . "\n"
                          . '  </tr>'
                          . "\n"
        ...
        $confirm_string .= '<a href="' . tep_href_link(FILENAME_NEWSLETTERS, 'page=' . $_GET['page'] . '&nID=' . $_GET['nID'] . '&action=send') . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a> <a href="' . tep_href_link(
            FILENAME_NEWSLETTERS,
    ...
    public function send($newsletter_id)
    {
        ...
        if (isset($_POST['global']) && ('true' == $_POST['global'])) {
            ...
            while (false !== ($products = tep_db_fetch_array($products_query))) {
                $audience[$products['customers_id']] = [
...
'email_address' => $products['customers_email_address'],
            ...
            while (false !== ($customers = tep_db_fetch_array($customers_query))) {
                $audience[$customers['customers_id']] = [

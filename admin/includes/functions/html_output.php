...
/*
  $Id: html_output.php,v 1.1 2006/03/27 09:06:04 mikhail Exp $
...
function tep_href_link($page = '', $parameters = '', $connection = 'NONSSL')
{
    ...
    if ('NONSSL' == $connection) {
        ...
        die(
            '</td></tr></table></td></tr></table><br><br><font color="#ff0000"><b>Error!</b></font><br><br><b>Unable to determine connection method on a link!<br><br>Known methods: NONSSL SSL<br><br>Function used:<br><br>tep_href_link(\''
            . $page
            . '\', \''
            . $parameters
            . '\', \''
    ...
    while (('&' == mb_substr($link, -1)) || ('?' == mb_substr($link, -1))) {
...
function tep_js_zone_list($country, $form, $field)
{
    ...
    while (false !== ($countries = tep_db_fetch_array($countries_query))) {
        ...
        while (false !== ($states = tep_db_fetch_array($states_query))) {
            if ('1' == $num_state) {
...
function tep_draw_input_field($name, $value = '', $parameters = '', $required = false, $type = 'text', $reinsert_value = true)
{
    ...
    if (isset($GLOBALS[$name]) && (true === $reinsert_value) && is_string($GLOBALS[$name])) {
...
function tep_draw_selection_field($name, $type, $value = '', $checked = false, $compare = '')
{
    ...
    if ((true === $checked) || (isset($GLOBALS[$name]) && is_string($GLOBALS[$name]) && ('on' == $GLOBALS[$name])) || (isset($value) && isset($GLOBALS[$name]) && (stripslashes($GLOBALS[$name]) == $value)) || (tep_not_null($value) && tep_not_null($compare) && ($value == $compare))) {
        $selection .= ' CHECKED';
    }
...
function tep_draw_textarea_field($name, $wrap, $width, $height, $text = '', $parameters = '', $reinsert_value = true)
{
    ...
    if ((isset($GLOBALS[$name])) && (true === $reinsert_value)) {

...
/*
  $Id: validations.php,v 1.1 2006/03/27 09:06:04 mikhail Exp $
            ...
            if (eregi($ip_domain_pat, $domain, $ip_components)) {
                ...
                if (eregi($domain_pat, $domain)) {
                    ...
                    if (count($domain_components) < 2) {
                        ...
                        $top_level_domain = mb_strtolower($domain_components[count($domain_components) - 1]);

                        // Allow all 2-letter TLDs (ccTLDs)

                        if (1 != eregi('^[a-z][a-z]$', $top_level_domain)) {
                            $tld_pattern = '';
                            ...
                            $tld_pattern = mb_substr($tld_pattern, 0, -1);

                            if (0 == eregi((string)$tld_pattern, $top_level_domain)) {
                                $valid_address = false;
                            }
                        }
                    }

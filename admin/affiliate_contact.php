...
/*
  $Id: affiliate_contact.php,v 2.00 2004/10/12
...
if (('send_email_to_user' == $_GET['action']) && ($_POST['affiliate_email_address']) && (!$_POST['back_x'])) {
    ...
    $mimemessage = new email(['X-Mailer: osCommerce']);
    ...
    while (false !== ($mail = tep_db_fetch_array($mail_query))) {
...
if (('preview' == $_GET['action']) && (!$_POST['affiliate_email_address'])) {
                    ...
                    <td>
                        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                            ...
                            if (('preview' == $_GET['action']) && ($_POST['affiliate_email_address'])) {
                                ...
                                <tr><?php echo tep_draw_form('mail', FILENAME_AFFILIATE_CONTACT, 'action=send_email_to_user'); ?>
                                    <td>
                                        <table border="0" width="100%" cellpadding="0" cellspacing="2">
                                            ...
                                            <tr>
                                                <td class="smallText"><b><?php echo TEXT_FROM; ?></b><br><?php echo htmlspecialchars(stripslashes($_POST['from']), ENT_QUOTES | ENT_HTML5); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="smallText"><b><?php echo TEXT_SUBJECT; ?></b><br><?php echo htmlspecialchars(stripslashes($_POST['subject']), ENT_QUOTES | ENT_HTML5); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="smallText"><b><?php echo TEXT_MESSAGE; ?></b><br><?php echo nl2br(htmlspecialchars(stripslashes($_POST['message']), ENT_QUOTES | ENT_HTML5)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
                                            </tr>
                                ...
                                $affiliate[] = ['id' => '', 'text' => TEXT_SELECT_AFFILIATE];

                                $affiliate[] = ['id' => '***', 'text' => TEXT_ALL_AFFILIATES];
                                ...
                                while (false !== ($affiliate_values = tep_db_fetch_array($mail_query))) {
                                    $affiliate[] = [

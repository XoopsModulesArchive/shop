...
/*
  $Id: mail.php,v 1.1 2006/03/27 09:05:33 mikhail Exp $
...
if (('send_email_to_user' == $action) && isset($_POST['customers_email_address']) && !isset($_POST['back_x'])) {
...
if (('preview' == $action) && !isset($_POST['customers_email_address'])) {
                    ...
                    <td>
                        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                            ...
                            if (('preview' == $action) && isset($_POST['customers_email_address'])) {
                                ...
                                while (false !== ($customers_values = tep_db_fetch_array($mail_query))) {
                                    $customers[] = [

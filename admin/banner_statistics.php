...
/*
  $Id: banner_statistics.php,v 1.1 2006/03/27 09:05:33 mikhail Exp $
...
while (false !== ($years = tep_db_fetch_array($years_query))) {
    $years_array[] = [
        ...
        <td width="100%" valign="top">
            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                    ...
                    <td width="100%">
                        <table border="0" width="100%" cellspacing="0" cellpadding="0">
                            <tr><?php echo tep_draw_form('year', FILENAME_BANNER_STATISTICS, '', 'get'); ?>
                                ...
                                <td class="main" align="right"><?php echo TITLE_TYPE . ' ' . tep_draw_pull_down_menu('type', $type_array, (tep_not_null($type) ? $type : 'daily'), 'onChange="this.form.submit();"'); ?>
                                    ...
                                    switch ($type) {
                                        case 'yearly':
                                            break;
                                        case 'monthly':
                                            echo TITLE_YEAR . ' ' . tep_draw_pull_down_menu('year', $years_array, ($_GET['year'] ?? date('Y')), 'onChange="this.form.submit();"') . '<noscript><input type="submit" value="GO"></noscript>';
                                            break;
                                        default:
                                        case 'daily':
                                            echo TITLE_MONTH
                                                 . ' '
                                                 . tep_draw_pull_down_menu('month', $months_array, ($_GET['month'] ?? date('n')), 'onChange="this.form.submit();"')
                                                 . '<noscript><input type="submit" value="GO"></noscript><br>'
                                                 . TITLE_YEAR
                                                 . ' '
                                                 . tep_draw_pull_down_menu('year', $years_array, ($_GET['year'] ?? date('Y')), 'onChange="this.form.submit();"')
                                                 . '<noscript><input type="submit" value="GO"></noscript>';
                                            break;
                                    }
                                    ?>
                ...
                <tr>
                    <td align="center">
                        <?php
                        if (function_exists('imagecreate') && (true === $dir_ok) && tep_not_null($banner_extension)) {
                            ...
                            <table border="0" width="600" cellspacing="0" cellpadding="2">
                                ...
                                for ($i = 0, $n = count($stats); $i < $n; $i++) {
                                    echo '            <tr class="dataTableRow">'
                                         ...
                                         . number_format($stats[$i][1])
                                         . '</td>'
                                         . "\n"
                                         . '              <td class="dataTableContent" align="right">'
                                         . number_format($stats[$i][2])
                                         . '</td>'
                                         . "\n"
                                         . '            </tr>'
                                         . "\n";

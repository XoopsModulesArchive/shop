...
/*
  $Id: stats_products_purchased.php,v 1.1 2006/03/27 09:05:33 mikhail Exp $
                            ...
                            <tr>
                                <td valign="top">
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        ...
                                        $products_query_raw = 'select p.products_id, p.products_ordered, pd.products_name from '
                                                              . TABLE_PRODUCTS
                                                              . ' p, '
                                        ...
                                        while (false !== ($products = tep_db_fetch_array($products_query))) {
                                            ...
                                            <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"
                                                onclick="document.location.href='<?php echo tep_href_link(FILENAME_CATEGORIES, 'action=new_product_preview&read=only&pID=' . $products['products_id'] . '&origin=' . FILENAME_STATS_PRODUCTS_PURCHASED . '?page=' . $_GET['page'], 'NONSSL'); ?>'">
                                                <td class="dataTableContent"><?php echo $rows; ?>.</td>
                                                <td class="dataTableContent"><?php echo '<a href="' . tep_href_link(
                                                FILENAME_CATEGORIES,

<?php
/*
  $Id: affiliate_summary.php,v 2.00 2004/10/12
                                                                ...
                                                                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                                                <tr>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_ACCOUNT, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_ACCOUNT
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_NEWSLETTER, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_NEWSLETTER
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_PASSWORD, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_PASSWORD
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_NEWS, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_NEWS
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                                                <tr>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_BANNERS_BANNERS, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_BANNERS_BANNERS
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_BANNERS_BUILD, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_BANNERS_BUILD
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_BANNERS_PRODUCT, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_BANNERS_PRODUCT
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_BANNERS_TEXT, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_BANNERS_TEXT
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                                                <tr>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_CLICKS, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_CLICKRATE
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_PAYMENT, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_PAYMENT
                                                                                                                                                                                                       . '</a>'; ?></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="main" width="50%"><img src="images/arrow_green.gif" border="0" alt="" width="12" height="10"><?php echo '<a href="'
                                                                                                                                                                                                       . tep_href_link(FILENAME_AFFILIATE_SALES, '', 'SSL')
                                                                                                                                                                                                       . '">'
                                                                                                                                                                                                       . TEXT_AFFILIATE_SALES
                                                                                                                                                                                                       . '</a>'; ?></td>

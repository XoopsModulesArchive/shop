<?php
/*
  $Id: shopping_cart.php,v 1.1 2006/03/27 08:50:00 mikhail Exp $
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                if ($cart->count_contents() > 0) {
                    ...
                    for ($i = 0, $n = count($products); $i < $n; $i++) {
                        ...
                        $cur_row = count($info_box_contents) - 1;

                        $info_box_contents[$cur_row][] = [
                                    'align'  => 'center',
                                    'params' => 'class="productListing-data" valign="top"',
                                    'text'   => tep_draw_checkbox_field('cart_delete[]', $products[$i]['id']),
                                ];

                        $products_name = '<table border="0" cellspacing="2" cellpadding="2">' . '  <tr>' . '    <td class="productListing-data" align="center"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products[$i]['id']) . '">' . tep_image(
                            DIR_WS_IMAGES . $products[$i]['image'],
                            $products[$i]['name'],
                            SMALL_IMAGE_WIDTH,
                            SMALL_IMAGE_HEIGHT
                        ) . '</a></td>' . '    <td class="productListing-data" valign="top"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products[$i]['id']) . '"><b>' . $products[$i]['name'] . '</b></a>';
                    ...
                    if (isset($navigation->path[$back])) {
                        ?>
                                                    <td class="main"><?php echo '<a href="' . tep_href_link($navigation->path[$back]['page'], tep_array_to_string($navigation->path[$back]['get'], ['action']), $navigation->path[$back]['mode']) . '">' . tep_image_button(

<?php
/*
  $Id: upcoming_products.php,v 1.1 2006/03/27 09:13:58 mikhail Exp $
        ...
        <td><br>
            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    <?php
                    $row = 0;
    while (false !== ($expected = tep_db_fetch_array($expected_query))) {
        $row++;
        ...
        echo '                <td class="smallText">&nbsp;<a href="'
                             . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $expected['products_id'])
                             . '">'

                        ...
                        <td class="main">
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    ...
                                    <td class="main">&nbsp;
                                        <?php
                                        echo tep_draw_checkbox_field('a_agb', $value = '1', $checked = $affiliate['affiliate_agb'])
                                             . ENTRY_AFFILIATE_ACCEPT_AGB
                                             . '<b><a href="javascript:popupWindow(\''
                                             . tep_href_link(FILENAME_AFFILIATE_TERMS_POPUP, '', 'SSL')
                                             . '\')">'
                                             . ENTRY_AFFILIATE_ACCEPT_AGB_TEXT
                                             . '</a></b>';

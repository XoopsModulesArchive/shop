<?php
/*
  $Id: authorizenet.php,v 1.1 2006/03/27 09:14:03 mikhail Exp $
...
class authorizenet
{
    ...
    public function CalculateFP($loginid, $txnkey, $amount, $sequence, $tstamp, $currency = "")
    {
    ...
    public function InsertFP($loginid, $txnkey, $amount, $sequence, $currency = "")
    {
        ...
        $str = tep_draw_hidden_field('x_fp_sequence', $sequence) . tep_draw_hidden_field('x_fp_timestamp', $tstamp) . tep_draw_hidden_field('x_fp_hash', $fingerprint);
    ...
    public function javascript_validation()
    {
        $js = '  if (payment_value == "'
              ...
              . MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_OWNER
              . '";'
              . "\n"
              . '      error = 1;'
              . "\n"
              ...
              . "\n"
              . '      error_message = error_message + "'
              . MODULE_PAYMENT_AUTHORIZENET_TEXT_JS_CC_NUMBER
              . '";'
              . "\n"
              . '      error = 1;'
              . "\n"
    ...
    public function selection()
    {
        ...
        $selection = [
            ...
            'fields' => [
                [
                    'title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_OWNER,
                    'field' => tep_draw_input_field('authorizenet_cc_owner', $order->billing['firstname'] . ' ' . $order->billing['lastname']),
                ],
                [
                    'title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_NUMBER,
                    'field' => tep_draw_input_field('authorizenet_cc_number'),
                ],
                [
                    'title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_CREDIT_CARD_EXPIRES,
    ...
    public function pre_confirmation_check()
    {
        ...
        if (($result === false) || ($result < 1)) {
            $payment_error_return = 'payment_error='
                                    ...
                                    . urlencode($_POST['authorizenet_cc_owner'])
    ...
    public function get_error()
    {
        ...
        $error = [
            'title' => MODULE_PAYMENT_AUTHORIZENET_TEXT_ERROR,
    ...
    public function install()
    {
        ...
        tep_db_query(
            "insert into "
            . TABLE_CONFIGURATION
            . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Login Username', 'MODULE_PAYMENT_AUTHORIZENET_LOGIN', 'testing', 'The login username used for the Authorize.net service', '6', '0', now())"
        );
        tep_db_query(
            "insert into "
            . TABLE_CONFIGURATION
            . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Transaction Key', 'MODULE_PAYMENT_AUTHORIZENET_TXNKEY', 'Test', 'Transaction Key used for encrypting TP data', '6', '0', now())"
        );
        tep_db_query(
            "insert into "
            . TABLE_CONFIGURATION
        ...
        tep_db_query(
            "insert into "
            . TABLE_CONFIGURATION
            . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort order of display.', 'MODULE_PAYMENT_AUTHORIZENET_SORT_ORDER', '0', 'Sort order of display. Lowest is displayed first.', '6', '0', now())"
        );
        tep_db_query(
            "insert into "
            . TABLE_CONFIGURATION

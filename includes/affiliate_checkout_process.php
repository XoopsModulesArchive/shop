...
/*
  $Id: affiliate_checkout_process.php,v 2.00 2004/10/12
...
'affiliate_salesman' => $affiliate_ref,
    ...
    if (AFFILATE_USE_TIER == 'true') {
        $affiliate_tiers_query = tep_db_query(
            "SELECT aa2.affiliate_id, (aa2.affiliate_rgt - aa2.affiliate_lft) as height
        ...
        while (false !== ($affiliate_tiers_array = tep_db_fetch_array($affiliate_tiers_query))) {
            ...
            if ($affiliate_payment > 0) {
                $sql_data_array = [
                    'affiliate_id' => $affiliate_tiers_array['affiliate_id'],
'affiliate_date' => $affiliate_clientdate,
'affiliate_browser' => $affiliate_clientbrowser,
'affiliate_ipaddress' => $affiliate_clientip,
'affiliate_value' => $affiliate_total,

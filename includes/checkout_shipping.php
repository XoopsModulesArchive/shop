<?php
/*
  $Id: checkout_shipping.php,v 1.1 2006/03/27 08:50:00 mikhail Exp $
...
require __DIR__ . '/includes/classes/http_client.php';
                                ...
                                <td>
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        <tr>
                                            ...
                                            <td class="main" width="50%" valign="top"><?php echo TEXT_CHOOSE_SHIPPING_DESTINATION . '<br><br><a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING_ADDRESS, '', 'SSL') . '">' . tep_image_button(
                                                            ...
                                                            <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                                ...
                                                                if (isset($quotes[$i]['error'])) {
                                                                    ...
                                                                    for ($j = 0, $n2 = count($quotes[$i]['methods']); $j < $n2; $j++) {
                                                                        ...
                                                                        if (($n > 1) || ($n2 > 1)) {
                                                                            ?>
                                                                            <td class="main"><?php echo $currencies->format(tep_add_tax($quotes[$i]['methods'][$j]['cost'], ($quotes[$i]['tax'] ?? 0))); ?></td>
                                                                            <td class="main" align="right"><?php echo tep_draw_radio_field('shipping', $quotes[$i]['id'] . '_' . $quotes[$i]['methods'][$j]['id'], $checked); ?></td>
                                                                            <?php
                                                                        } else {
                                                                            ?>
                                                                            <td class="main" align="right" colspan="2"><?php echo $currencies->format(tep_add_tax($quotes[$i]['methods'][$j]['cost'], $quotes[$i]['tax'])) . tep_draw_hidden_field(
                                                                                        'shipping',
...
<?php require DIR_WS_INCLUDES . 'application_bottom.php'; ?>
SESSION['shipping']) || (tep_isset(\<?php
/*
  $Id: checkout_shipping.php,v 1.1 2006/03/27 08:50:00 mikhail Exp $
...
<?php require DIR_WS_INCLUDES . 'application_bottom.php'; ?>
SESSION['shipping']) && ($shipping === false) && (tep_count_shipping_modules() > 1))) {
    $shipping = $shipping_modules->cheapest();
}

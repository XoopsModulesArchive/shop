...
/*
  $Id: affiliate_application_top.php,v 2.00 2004/10/12
...
define('TABLE_AFFILIATE', XOOPS_SHOPDB_PREFIX . '_affiliate_affiliate');
define('TABLE_AFFILIATE_NEWS', XOOPS_SHOPDB_PREFIX . '_affiliate_news');

// if you change this -> affiliate_show_banner must be changed too
define('TABLE_AFFILIATE_BANNERS', XOOPS_SHOPDB_PREFIX . '_affiliate_banners');
define('TABLE_AFFILIATE_BANNERS_HISTORY', XOOPS_SHOPDB_PREFIX . '_affiliate_banners_history');
define('TABLE_AFFILIATE_CLICKTHROUGHS', XOOPS_SHOPDB_PREFIX . '_affiliate_clickthroughs');
define('TABLE_AFFILIATE_SALES', XOOPS_SHOPDB_PREFIX . '_affiliate_sales');
define('TABLE_AFFILIATE_PAYMENT', XOOPS_SHOPDB_PREFIX . '_affiliate_payment');
define('TABLE_AFFILIATE_PAYMENT_STATUS', XOOPS_SHOPDB_PREFIX . '_affiliate_payment_status');
define('TABLE_AFFILIATE_PAYMENT_STATUS_HISTORY', XOOPS_SHOPDB_PREFIX . '_affiliate_payment_status_history');
        ...
        if ($affiliate_banner_id && $affiliate_ref) {
            ...
            if (tep_db_fetch_array($banner_stats_query)) {
                tep_db_query(
                    ...
                    . " set affiliate_banners_clicks = affiliate_banners_clicks + 1 where affiliate_banners_id = '"
                    . $affiliate_banner_id
...
if (!isset($request_type)) {
    $request_type = ('on' == getenv('HTTPS')) ? 'SSL' : 'NONSSL';
}

<?php
/*
  $Id: cookie_usage.php,v 1.1 2006/03/27 08:50:00 mikhail Exp $
                ...
                <tr>
                    <td class="main">
                        <table border="0" width="40%" cellspacing="0" cellpadding="0" align="right">
                            <tr>
                                <td><?php new infoBoxHeading([['text' => BOX_INFORMATION_HEADING]]); ?></td>
                            </tr>
                            <tr>
                                <td><?php new infoBox([['text' => BOX_INFORMATION]]); ?></td>
                            </tr>

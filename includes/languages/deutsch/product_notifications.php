<?php
/*
  $Id: product_notifications.php,v 1.1 2006/03/27 09:13:10 mikhail Exp $
...
define(
    'TEXT_PRODUCT_NOTIFICATIONS_LIST',
    'Nachfolgend aufgef&uuml;hrt ist eine Liste mit Produkten, &uuml;ber die Sie aktuell informiert werden wollen. Wenn Sie ein oder mehrere Produkte von dieser Liste l&ouml;schen wollen, so w&auml;hlen Sie diese bitte aus und klicken anschliessend auf den Button \'Benachrichtigung löschen\'.'
);

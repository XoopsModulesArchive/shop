<?php
/*
  $Id: compatibility.php,v 1.1 2006/03/27 09:08:28 mikhail Exp $
...
if (!function_exists('array_merge')) {
    ...
    {
        if (empty($array3) && !is_array($array3)) {
            $array3 = [];
        }
...
if (!function_exists('array_slice')) {
    function array_slice($array, $offset, $length = 0)
    {
        ...
        $length = ((!$length) ? count($array) : (($length < 0) ? count($array) - $length : $length + $offset));

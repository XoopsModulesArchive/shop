<?php
/*
  $Id: affiliate_password.php,v 2.00 2004/10/12
...
<table border="0" width="100%" cellspacing="3" cellpadding="3">
    <tr>
        ...
        <!-- body_text //-->
        <td width="100%" valign="top"><?php echo tep_draw_form('a_password', tep_href_link(FILENAME_AFFILIATE_PASSWORD, '', 'SSL'), 'post', 'onSubmit="return check_form(a_password);"') . tep_draw_hidden_field('action', 'process'); ?>

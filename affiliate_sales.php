                        ...
                        <table border="0" width="100%" cellspacing="0" cellpadding="4">
                            ...
                            if ($affiliate_sales_split->number_of_rows > 0) {
                                ...
                                while (false !== ($affiliate_sales = tep_db_fetch_array($affiliate_sales_values))) {
                                    ...
                                    <td class="smallText" align="right"><?php if ($affiliate_sales['orders_status']) {
                                ...
                                <td colspan="5">
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        <tr>
                                            ...
                                            <td class="smallText" align="right"><?php echo TEXT_RESULT_PAGE; ?><?php echo $affiliate_sales_split->display_links(MAX_DISPLAY_PAGE_LINKS, tep_get_all_get_params(['page', 'info', 'x', 'y'])); ?></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>

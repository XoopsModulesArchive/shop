<?php
/*
  $Id: affiliate_banners_banners.php,v 2.00 2004/10/12
                    ...
                    <td>
                        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
                            <td>
                                ...
                                while (false !== ($affiliate_banners = tep_db_fetch_array($affiliate_banners_values))) {
                                    ...
                                    case 1: // Link to Products
                                        if ($prod_id < 1) {
                                            $link  = '<a href="'
                                                     ...
                                                     . DIR_WS_CATALOG
                                                     . DIR_WS_IMAGES
                                                     . $affiliate_banners['affiliate_banners_image']
                                                     . '" border="0" alt="'
                                                     . $affiliate_banners['affiliate_banners_title']
                                                     . '"></a>';
                                            $link1 = '<a href="'
                                                     . HTTP_SERVER
                                                     . DIR_WS_CATALOG

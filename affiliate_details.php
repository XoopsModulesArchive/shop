<?php
/*
  $Id: affiliate_details.php,v 2.00 2004/10/12
...
<table border="0" width="100%" cellspacing="3" cellpadding="3">
    <tr>
        ...
        ?>
        <td width="100%" valign="top"><?php echo tep_draw_form('affiliate_details', tep_href_link(FILENAME_AFFILIATE_DETAILS, '', 'SSL'), 'post', 'onSubmit="return check_form();"') . tep_draw_hidden_field('action', 'process'); ?>

                                    ...
                                    <td colspan="4">
                                        <table border="0" width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td align="right" class="smallText"><?php echo TEXT_RESULT_PAGE; ?><?php echo $affiliate_clickthroughs_split->display_links(MAX_DISPLAY_PAGE_LINKS, tep_get_all_get_params(['page', 'info', 'x', 'y'])); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>

                    ...
                    <td>
                        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                            ...
                            if ($affiliate_payment_split->number_of_rows > 0) {
                                ...
                                $number_of_payment        = 0;
                                while (false !== ($affiliate_payment = tep_db_fetch_array($affiliate_payment_values))) {
                                    $number_of_payment++;
                                    ...
                                    <td colspan="4">
                                        <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                            <tr>
                                                ...
                                                <td align="right" class="smallText"><?php echo TEXT_RESULT_PAGE; ?><?php echo $affiliate_payment_split->display_links(MAX_DISPLAY_PAGE_LINKS, tep_get_all_get_params(['page', 'info', 'x', 'y'])); ?></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>

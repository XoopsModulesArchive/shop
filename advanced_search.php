...
/*
  $Id: advanced_search.php,v 1.1 2006/03/27 08:42:21 mikhail Exp $
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>
                        <?php
                        $info_box_contents = [];
                        $info_box_contents[] = ['text' => HEADING_SEARCH_CRITERIA];

                        new infoBoxHeading($info_box_contents, true, true);

                        $info_box_contents = [];
                        $info_box_contents[] = ['text' => tep_draw_input_field('keywords', '', 'style="width: 100%"')];
                        $info_box_contents[] = ['align' => 'right', 'text' => tep_draw_checkbox_field('search_in_description', '1') . ' ' . TEXT_SEARCH_IN_DESCRIPTION];
                                ...
                                <td>
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        <tr>
                                            ...
                                            <td class="fieldValue"><?php echo tep_draw_pull_down_menu('categories_id', tep_get_categories([['id' => '', 'text' => TEXT_ALL_CATEGORIES]])); ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="fieldValue"><?php echo tep_draw_pull_down_menu('manufacturers_id', tep_get_manufacturers([['id' => '', 'text' => TEXT_ALL_MANUFACTURERS]])); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
                                        </tr>

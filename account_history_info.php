<?php
/*
  $Id: account_history_info.php,v 1.1 2006/03/27 08:42:21 mikhail Exp $
                                            ...
                                            <td>
                                                <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                    ...
                                                    for ($i = 0, $n = count($order->products); $i < $n; $i++) {
                                                        ...
                                                        echo '            <td class="main" align="right" valign="top">' . $currencies->format(
                                ...
                                <td valign="top">
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        ...
                                        $statuses_query = tep_db_query(
                                            "select os.orders_status_name, osh.date_added, osh.comments from "
                                            . TABLE_ORDERS_STATUS
                                            . " os, "
                                            . TABLE_ORDERS_STATUS_HISTORY
                                            . " osh where osh.orders_id = '"
                                            . (int)$_GET['order_id']
                                            . "' and osh.orders_status_id = os.orders_status_id and os.language_id = '"
                                            . (int)$languages_id
                                        ...
                                        while (false !== ($statuses = tep_db_fetch_array($statuses_query))) {
                                            echo '              <tr>'
                                                 ...
                                                 . tep_date_short($statuses['date_added'])
                                                 . '</td>'
                                                 . "\n"
                                                 . '                <td class="main" valign="top" width="70">'
                                ...
                                <td>
                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                        <tr>
                                            ...
                                            <td><?php echo '<a href="' . tep_href_link(FILENAME_ACCOUNT_HISTORY, tep_get_all_get_params(['order_id']), 'SSL') . '">' . tep_image_button('button_back.gif', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
                                            <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                                        </tr>
                                    </table>
                                </td>

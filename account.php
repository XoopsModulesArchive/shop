<?php
/*
  $Id: account.php,v 1.1 2006/03/27 08:45:31 mikhail Exp $
                                                ...
                                                <td>
                                                    <table border="0" width="100%" cellspacing="0" cellpadding="2">
                                                        ...
                                                        $orders_query = tep_db_query(
                                                            "select o.orders_id, o.date_purchased, o.delivery_name, o.delivery_country, o.billing_name, o.billing_country, ot.text as order_total, s.orders_status_name from "
                                                            . TABLE_ORDERS
                                                            . " o, "
                                                            . TABLE_ORDERS_TOTAL
                                                            . " ot, "

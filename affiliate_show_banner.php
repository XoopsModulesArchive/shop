...
/*
  $Id: affiliate_show_banner.php,v 2.00 2004/10/12
...
if (file_exists('includes/local/affiliate_configure.php')) {
    require __DIR__ . '/includes/local/affiliate_configure.php';
}
require __DIR__ . '/includes/affiliate_configure.php';
...
function affiliate_show_banner($pic)
{
    ...
    $img_type = mb_substr($pic, mb_strrpos($pic, '.') + 1);
    ...
    if ($pos) {
        $img_name = mb_substr($pic, mb_strrpos($pic, '/') + 1);
    } else {
        $img_name = $pic;
    }
...
function affiliate_debug($banner, $sql)
{
    ...
    <table border=1 cellpadding=2 cellspacing=2>
        ...
        <tr>
            ...
            <td><?php echo DIR_FS_CATALOG . DIR_WS_IMAGES . $banner; ?></td>
        </tr>
        <tr>
            <td>build with:</td>
            <td>DIR_FS_CATALOG . DIR_WS_IMAGES . $banner</td>
        </tr>
        <tr>
            <td>DIR_FS_CATALOG</td>
            <td><?php echo DIR_FS_CATALOG; ?></td>
        </tr>
        <tr>
            <td>DIR_WS_CATALOG</td>
            <td><?php echo DIR_WS_CATALOG; ?></td>
        </tr>
        <tr>
            <td>DIR_WS_IMAGES</td>
            <td><?php echo DIR_WS_IMAGES; ?></td>
        </tr>
        <tr>
            <td>$banner</td>
...
if ($_POST['affiliate_banner_id']) {
    $banner_id = $_POST['affiliate_banner_id'];
}
if ($_GET['affiliate_pbanner_id']) {
    $prod_banner_id = $_GET['affiliate_pbanner_id'];
}
if ($_POST['affiliate_pbanner_id']) {
    $prod_banner_id = $_POST['affiliate_pbanner_id'];
}
...
// DebugModus
if (AFFILIATE_SHOW_BANNERS_DEBUG == 'true') {
...
if ($banner) {
    ...
    if (is_file($pic)) {
        ...
        if ($affiliate_id) {
            $banner_stats_query = tep_db_query(
                'select * from ' . TABLE_AFFILIATE_BANNERS_HISTORY . " where affiliate_banners_id = '" . $banner_id . "' and affiliate_banners_products_id = '" . $products_id . "' and affiliate_banners_affiliate_id = '" . $affiliate_id . "' and affiliate_banners_history_date = '" . $today . "'"
            );
            ...
            if ($banner_stats_array = tep_db_fetch_array($banner_stats_query)) {
                tep_db_query(
                    ...
                    . " set affiliate_banners_shown = affiliate_banners_shown + 1 where affiliate_banners_id = '"
                    . $banner_id
                    . "' and affiliate_banners_affiliate_id = '"
                    . $affiliate_id
                    . "' and affiliate_banners_products_id = '"
                    . $products_id
                    . "' and affiliate_banners_history_date = '"
                    . $today
                    . "'"
                );
                ...
                tep_db_query(
                    'insert into '
                    . TABLE_AFFILIATE_BANNERS_HISTORY
                    . " (affiliate_banners_id, affiliate_banners_products_id, affiliate_banners_affiliate_id, affiliate_banners_shown, affiliate_banners_history_date) VALUES ('"
                    . $banner_id
                    . "', '"
                    . $products_id
                    . "', '"
